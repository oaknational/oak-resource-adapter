...
import type {
  ...
  ResourceDocumentV0_1,
  ResourceNode,
  SourceMap,
  WorksheetDocumentV0_1,
  WorksheetMetadata,
} from "./types.js";
...
export type SchemaTypeAssertions = [
  ...
  Expect<Exact<WorksheetDocumentV0_1, z.output<typeof worksheetDocumentV0_1Schema>>>,
  Expect<Exact<GenericDocumentV0_1, z.output<typeof genericDocumentV0_1Schema>>>,
  Expect<Exact<ResourceDocumentV0_1, z.output<typeof resourceDocumentV0_1Schema>>>,
];
