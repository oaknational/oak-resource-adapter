        ...
        {storedDownloads ? (
          <>
            ...
            <ArtifactDownloadPanel
              ...
              isShared={artifactIsShared}
            />
          </>
        ) : (
          <>
            <p>
              Download a fixture as a Word document without running a transformation.
            </p>
            <ScenarioSelect
            ...
            <section aria-labelledby="docx-export-controls" className={styles.controls}>
              ...
              <p className={styles.controlNote}>
                Pupil content only: answers are excluded and maths is plain text.
                Figures fall back to their caption and alt text unless they are a PNG or
                JPEG from an origin the API allows.
              </p>
              <p className={styles.controlNote}>
